...
const AdminLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    if (!formData.username.trim() || !formData.password) {
      setErrors({
        username: !formData.username.trim() ? ['Username wajib diisi'] : null,
        password: !formData.password ? ['Password wajib diisi'] : null
      });
      return;
    }
    ...
    try {
      ...
      // Pastikan response sesuai dengan struktur dari Laravel
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 to-purple-700 p-4">
      ...
      {/* Login Card */}
      <div className="relative z-10 bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden w-full max-w-md">
        {/* Header */}
        ...
        <div className="p-8">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  name="username"
                  className={`block w-full pl-10 pr-3 py-3 border ${errors.username ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all`}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  type="password"
                  name="password"
                  className={`block w-full pl-10 pr-3 py-3 border ${errors.password ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all`}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-all flex justify-center items-center ${isLoading ? 'opacity-75 cursor-not-allowed' : ''}`}
            >
              {isLoading ? (
                <>
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            <p>© {new Date().getFullYear()} Aplikasi Web HaloSani. All rights reserved.</p>
          </div>
        </div>
      </div>
