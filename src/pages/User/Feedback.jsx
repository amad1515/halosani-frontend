...
const Feedback = () => {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-50 p-4">
        ...
        >
          <motion.div
            ...
            className="mb-8"
          >
            <FiHeart className="mx-auto text-red-500 w-16 h-16 md:w-24 md:h-24 fill-current" />
          </motion.div>
          <h1 className="text-3xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 mb-4 md:mb-6">
            Terima Kasih!
          </h1>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-6 py-2 md:px-8 md:py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl font-semibold shadow-lg text-sm md:text-base"
            >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 md:py-12 px-4 sm:px-6 lg:px-8">
      <motion.div
      ...
      >
        <div className="text-center mb-8 md:mb-12">
          <motion.h1 
            className="text-3xl md:text-5xl font-extrabold text-gray-900 sm:text-4xl md:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-indigo-600 mb-3 md:mb-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.p
            className="mt-2 md:mt-4 text-base md:text-xl text-gray-600 max-w-2xl mx-auto"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <svg className="w-8 h-8 md:w-12 md:h-12 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
            </svg>
          </motion.div>
        </div>
        ...
        <motion.div
          className="bg-white shadow-xl rounded-xl md:rounded-2xl p-6 md:p-8 mb-8 md:mb-10 backdrop-blur-sm bg-opacity-90"
        ...
        >
          <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-6 flex items-center">
            <div className="p-2 bg-blue-100 rounded-full mr-3">
              <FiUser className="text-blue-600 w-5 h-5 md:w-6 md:h-6" />
            </div>
            Informasi Anda
          </h2>
          <div className="grid grid-cols-1 gap-4 md:gap-6">
            <div>
              ...
              <input
                ...
                name="name"
                required
                className="w-full px-4 py-2 md:px-5 md:py-3 border border-gray-300 rounded-lg md:rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all shadow-sm text-sm md:text-base"
        ...
        <motion.form
          ...
          className="bg-white shadow-xl md:shadow-2xl rounded-xl md:rounded-3xl overflow-hidden backdrop-blur-sm bg-opacity-90"
        ...
        >
          <div className="p-6 md:p-8 lg:p-12">
            {/* Rating Keseluruhan */}
            <motion.div 
              className="mb-8 md:mb-12 p-6 md:p-8 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl md:rounded-2xl border border-blue-100"
              initial={{ x: -20, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
              transition={{ delay: 0.3 }}
            >
              ...
              <p className="text-gray-600 mb-4 md:mb-6 text-base md:text-lg">Bagaimana Anda menilai pengalaman keseluruhan dengan platform kami?</p>
              
              <div className="flex flex-wrap items-center justify-center gap-1 md:space-x-2 mb-6 md:mb-8">
                {[1, 2, 3, 4, 5].map((star) => (
                  <motion.button
                    key={star}
                    type="button"
                    ...
                    whileTap={{ scale: 0.9 }}
                    className={`p-1 md:p-2 rounded-full transition-all ${feedbackData.overall_rating >= star ? 'text-yellow-400' : 'text-gray-300 hover:text-yellow-300'}`}
                  >
                    <FiStar className="w-8 h-8 md:w-10 md:h-10 fill-current" />
                  </motion.button>
                ))}
              </div>
              ...
              <AnimatePresence>
                {feedbackData.overall_rating && (
                  ...
                  >
                    <label htmlFor="overall_reason" className="block text-base md:text-lg font-medium text-gray-700 mb-2 md:mb-3">
                    ...
                    <motion.textarea
                      ...
                      name="overall_reason"
                      rows={3}
                      className="w-full px-4 py-3 md:px-5 md:py-4 text-base md:text-lg border border-gray-300 rounded-lg md:rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all shadow-sm"
            ...
            <div className="space-y-8 md:space-y-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 md:mb-8 text-center">Rating Fitur</h2>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                {featureCategories.map((feature, index) => (
                  <motion.div 
                    key={feature.id}
                    className="bg-white p-6 md:p-8 rounded-xl md:rounded-2xl border-2 border-gray-100 hover:border-purple-200 transition-all shadow-md hover:shadow-lg md:hover:shadow-xl"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <div className="flex items-start mb-4 md:mb-6">
                      <div className="p-2 md:p-3 bg-gradient-to-br from-purple-100 to-blue-100 rounded-lg md:rounded-xl text-purple-600">
                        {feature.icon}
                      </div>
                      <div className="ml-3 md:ml-4">
                        <h3 className="text-lg md:text-xl font-semibold text-gray-800">{feature.label}</h3>
                        <p className="text-gray-500 text-sm md:text-base">{feature.description}</p>
                      </div>
                    </div>
                    
                    <div className="flex flex-wrap items-center gap-1 md:space-x-2 mb-4 md:mb-6">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <motion.button
                          key={star}
                          type="button"
                        ...
                        >
                          <FiStar className="w-6 h-6 md:w-8 md:h-8 fill-current" />
                        </motion.button>
                      ))}
                      <span className="ml-2 md:ml-3 text-sm md:text-base font-medium text-gray-500">
                    ...
                    <AnimatePresence>
                      {feedbackData[`${feature.id}_rating`] && (
                        ...
                        >
                          <label htmlFor={`${feature.id}_reason`} className="block text-sm md:text-base font-medium text-gray-700 mb-1 md:mb-2">
                          ...
                          <motion.textarea
                            ...
                            rows={2}
                            className="w-full px-3 py-2 md:px-4 md:py-3 text-sm md:text-base border border-gray-300 rounded-lg md:rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all shadow-sm"
            ...
            {/* Feedback Tambahan */}
            <motion.div 
              className="mt-12 md:mt-16 p-6 md:p-8 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl md:rounded-2xl border border-indigo-100"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <p className="text-gray-600 mb-4 md:mb-6 text-base md:text-lg">Apakah ada hal lain yang ingin Anda bagikan tentang pengalaman Anda dengan kami?</p>
              <motion.textarea
                name="additional_feedback"
                rows={4}
                className="w-full px-4 py-3 md:px-5 md:py-4 text-base md:text-lg border border-gray-300 rounded-lg md:rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all shadow-sm"
            ...
            <div className="mt-12 md:mt-16 flex justify-center">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className={`relative overflow-hidden inline-flex items-center px-6 py-3 md:px-10 md:py-5 border border-transparent text-base md:text-xl font-bold rounded-xl md:rounded-2xl text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 focus:outline-none focus:ring-4 focus:ring-purple-300 transition-all ${(submitting || !feedbackData.name) ? 'opacity-80 cursor-not-allowed' : ''}`}
              >
                {submitting ? (
                  <>
                  ...
                  <>
                    <FiSend className="mr-2 md:mr-3 w-4 h-4 md:w-6 md:h-6" />
        ...
        <motion.div 
          className="mt-12 md:mt-16 text-center text-gray-600 text-base md:text-lg"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.8 }}
        >
          <p className="mb-3 md:mb-4">Feedback jujur Anda membantu kami menciptakan pengalaman yang lebih baik untuk semua orang.</p>
          <motion.div 
